                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    if (!streamConfig.good())
        return; // No ColossusCoin.conf file is OK
    ...
    {
        // Don't overwrite existing settings so command line settings override ColossusCoin.conf
        ...
        else
        {
            ...
            if (!fDone)
            {
                ...
                if (!fMatch)
                {
                    ...
                    LogPrintf("*** %s\n", strMessage);
                    uiInterface.ThreadSafeMessageBox(strMessage+" ", string("ColossusCoin"), CClientUIInterface::MSG_WARNING);
                }
            }
        }
        if (fDebug) {
