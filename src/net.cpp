...
static const char *strDNSSeed[][2] = {
    ...
    {"hoboseed", "seed.colossuscoin.info"},
    {"hoboseed2", "seed2.colossuscoin.info"},
    {"hoboseed3", "seed3.colossuscoin.info"},
    {"hoboseed4", "seed4.colossuscoin.info"},
    {"cce",   "CV2.altcointech.net"},
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. ColossusCoin is probably already running."), addrBind.ToString());
        else
...
bool StopNode()
{
    ...
    if (vnThreadsRunning[THREAD_MINER] > 0) LogPrintf("ThreadBitcoinMiner still running\n");
