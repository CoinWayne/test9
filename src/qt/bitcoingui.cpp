...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ColossusCoin address"));
    ...
    aboutAction->setStatusTip(tr("Show information about ColossusCoin"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ColossusCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ColossusCoin addresses to prove you own them"));

    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ColossusCoin addresses"));
...
void BitcoinGUI::blocksIconClicked()
{
    ...
    message(tr("Extended Block Chain Information"),
        tr("Client Version: %1\n"
           ...
           .arg(tr("5.0000000")) // Hard Coded as CV2 is always 5, but should use GetProofOfWorkReward
...
{
    QString strTitle = tr("ColossusCoin") + " - ";
    ...
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            walletStack->gotoSendCoinsPage();
             ...
             message(tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid ColossusCoin address or malformed URI parameters."),
