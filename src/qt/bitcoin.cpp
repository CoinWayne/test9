...
int main(int argc, char *argv[])
{
    ...
    app.setOrganizationDomain("ColossusCoin.info");
...
#if defined(Q_OS_WIN) && QT_VERSION >= 0x050000
                 WinShutdownMonitor::registerShutdownBlockReason(QObject::tr("ColossusCoin shutting down. Please wait..."), (HWND)window.getMainWinId());
#endif
